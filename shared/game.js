...
export const MAP = {
  ...
  width: 15,
  height: 10,
  start: { x: 1, y: 0, direction: "east" },
  destination: { x: 13, y: 9 },
  // After crash, both spawn far apart so reunion is a real walk.
  driverSpawnAfterCrash:    { x: 0,  y: 9, label: "Evil Town / Arouca" },
  navigatorSpawnAfterCrash: { x: 14, y: 0, label: "Pretty Cool Girl City / Champs Fleurs" },
  zones: [
    { label: "Arouca",        x: 1,  y: 0 },
    { label: "Centre",        x: 7,  y: 4 },
    { label: "Champs Fleurs", x: 13, y: 0 },
    { label: "Maracas",       x: 13, y: 9 },
  ],
  tiles: [
    ".S.............".split(""),
    "###.#######.###".split(""),
